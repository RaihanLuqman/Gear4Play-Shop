        ...
        <aside class="sidebar">
            ...
            <nav class="content-sidebar">
                <ul>
                    ...
                    <li class="<?= ($current_page == 'myorder_detail.php') ? 'active' : ''; ?>">
                        <a href="myorder.php">
        ...
        <main class="main-content">
            ...
            <div class="container-kurir">
                ...
                <div class="header-kurir">
                    <h2 style="color:white">Estimasi Sampai: <?= htmlspecialchars($pengiriman_data['estimasi_sampai']) ?></h2>
                    <p style="color:white">No. Resi: #<?= htmlspecialchars($pengiriman_data['no_resi'] ?? 'N/A') ?></p>
                </div>
                ...
                <div class="timeline">
                    ...
                    foreach ($live_locations as $index => $location) {
                        ...
                        echo '<p><strong>' .  '</strong> ' . htmlspecialchars($location) . '</p>';
                        echo '</div>';
                    }
                    ?>
                </div>
                ...
                <?php if (!empty($pengiriman_data['proof_image'])): ?>
                    <div class="bukti-pengiriman">
                        <p>Bukti Pengiriman:</p>
                        <a href="../uploads/<?= htmlspecialchars($pengiriman_data['proof_image']) ?>" target="_blank">
                            <img src="../uploads/<?= htmlspecialchars($pengiriman_data['proof_image']) ?>" alt="Proof Image" style="max-width: 100%; height: auto;">
                        </a>
                    </div>
                <?php else: ?>
                    <p style="color:white; margin-top:15px">Bukti pengiriman belum tersedia.</p>
                <?php endif; ?>
            </div>
        </main>
    </div>
